...
* [Linux Directory Structure](linux/linux-directory-structure.md)
* [hostid](linux/hostid.md)
* [Process Substitution (프로세스 치환)](linux/process-substitution.md)
...
* [Page 2](ansible/page-2.md)
* [Role](ansible/role.md)
* [Ansible 명령어 정리](ansible/ansible/README.md)
  * [loop](ansible/ansible/loop.md)
  * [Docker-container](ansible/ansible/docker-container.md)
  * [Special Variables ( 특별한 변수들 )](ansible/ansible/special-variables.md)
  * [Controlling how Ansible behaves: precedence rules](ansible/ansible/controlling-how-ansible-behaves-precedence-rules.md)
  * [Docker를 Ansible로 설치하는 방법](ansible/ansible/docker-ansible.md)
  * [Docker-image-module](ansible/ansible/docker-image-module.md)
* [연결 방법 및 세부 사항](ansible/undefined.md)
* [에러 로그](ansible/undefined-1.md)
* [Ansible](ansible/ansible-1/README.md)
  * [Inventory Basics : formats, hosts, groups (형식, 호스트 및 그룹)](ansible/ansible-1/inventory-basics-formats-hosts-groups.md)
  * [Loops](ansible/ansible-1/loops.md)
* [Jinja2](ansible/jinja2.md)
...
* [Page 4](hypervisor/page-4.md)

## Container

* [Page 5](container/page-5.md)

## Container Registry&#x20;

* [Container Registry?](container-registry/container-registry.md)
* [Nexus Repository](container-registry/nexus-repository.md)

## Virtualization

* [Virsh](virtualization/virsh/README.md)
  * [libvirt](virtualization/virsh/libvirt.md)
* [KVM](virtualization/kvm.md)

## Terraform

* [Index](terraform/index.md)
...
* [routerOS](os/routeros/README.md)
  * [Firewall and QoS Case Studies](os/routeros/firewall-and-qos-case-studies/README.md)
    * [Packet Flow in RouterOS](os/routeros/firewall-and-qos-case-studies/packet-flow-in-routeros.md)
  * [Firewall and Quality of Service](os/routeros/firewall-and-quality-of-service/README.md)
    * [Mangle](os/routeros/firewall-and-quality-of-service/mangle.md)
    * [UPnP](os/routeros/firewall-and-quality-of-service/upnp.md)
    * [NAT](os/routeros/firewall-and-quality-of-service/nat.md)
